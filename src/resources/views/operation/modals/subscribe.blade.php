    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="formSubscribe" method="POST"
                      action="{{ route('operation.subscribe') }}">
                    {{ csrf_field() }}
                                        ...
                                        <div class="radio col-md-4" style="margin-top:-5px">
                                            <label>
                                                @if($loop->parent->first && $loop->first)
                                                    <input type="radio" name="character_id"
                                                           value="{{ $character->character_id }}" checked="checked"/>
                                                @else
                                                    <input type="radio" name="character_id"
                    ...
                    <div class="form-group row">
                        <label for="comment"
                               class="col-sm-2 col-form-label">{{ trans('calendar::seat.comment') }}</label>
                        <div class="col-sm-10">
